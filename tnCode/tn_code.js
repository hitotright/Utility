...
var tncode = {
    ...
    _send_result:function(){
        ...
        var re = new _ajax();
        re.request('get','/index.php/admin/login/tn_check?tn_r='+tncode._mark_offset,haddle);
    },
    ...
    refresh:function(){
        ...
        var img_url = "/index.php/admin/login/tn_code?t="+Math.random();
